 ...
 */
public class Sub implements Cpu.ClockedOpcodeConfiguration
{
    /*
    ...
    {
        // SUB
        config(registry, "0010_100*", "**_***_***", S(16, SubRmR.class, "SUB", "[M] <-  R"));
        config(registry, "0010_101*", "**_***_***", S( 9, SubRmR.class, "SUB", " R  <- [M]"));
        config(registry, "0010_10**", "11_***_***", S( 3, SubRmR.class, "SUB", " R  <-  R"), true);

        config(registry, "0010_110*",               S( 4, SubAccImm.class, "SUB", " A   <- I"));
        config(registry, "1000_00**", "**_101_***", S(17, SubRmImm.class,  "SUB", "[M]  <- I"));
        config(registry, "1000_00**", "11_101_***", S( 4, SubRmImm.class,  "SUB", " Rm  <- I"), true);

        // SBB
        config(registry, "0001_100*", "**_***_***", S(16, SbbRmR.class, "SBB", "[M] <-  R"));
        config(registry, "0001_101*", "**_***_***", S( 9, SbbRmR.class, "SBB", " R  <- [M]"));
        config(registry, "0001_10**", "11_***_***", S( 3, SbbRmR.class, "SBB", " R  <-  R"), true);

        config(registry, "0001_110*",               S( 4, SbbAccImm.class, "SBB", " A   <- I"));
        config(registry, "1000_00**", "**_011_***", S(17, SbbRmImm.class,  "SBB", "[M]  <- I"));
        config(registry, "1000_00**", "11_011_***", S( 4, SbbRmImm.class,  "SBB", " Rm  <- I"), true);

        // DEC
        config(registry, "0100_1***",               S( 2, DecReg.class, "DEC", "R16"));
        config(registry, "1111_111*", "**_001_***", S(15, DecRm.class, "DEC", "R"));
        config(registry, "1111_1110", "11_001_***", S( 3, DecRm.class, "DEC", "R8"), true);
        config(registry, "1111_1111", "11_001_***", S( 2, DecRm.class, "DEC", "R16"), true);

        // AAS & DAS
        config(registry, "0011_1111",               S( 4, Aas.class, "AAS", ""));
        config(registry, "0010_1111",               S( 4, Das.class, "DAS", ""));

        // NEG
        config(registry, "1111_011*", "**_011_***", S(16, NegRm.class, "NEG", "[M]"));
        config(registry, "1111_011*", "11_011_***", S( 3, NegRm.class, "NEG", "R"), true);
    }
     ...
     */
    public static class SubRmR extends Cpu.FixedClockOpcode {
        @Override
     ...
     * imm from reg/mem            100000sw m101r disp     disp    data   data(if s:w=01)
     */
    public static class SubRmImm extends Cpu.FixedClockOpcode {
        @Override
        public void executeClocked(Cpu cpu, int opcode) {
            boolean w = (opcode & 0b0000_0001) == 0b01;
     ...
     */
    public static class SubAccImm extends Cpu.FixedClockOpcode {
        @Override
        public void executeClocked(Cpu cpu, int opcode) {
            boolean w = (opcode & 0b0000_0001) == 0b01;
     ...
     */
    public static class SbbRmR extends Cpu.FixedClockOpcode {
        @Override
        public void executeClocked(Cpu cpu, int opcode)
        {
            boolean w = (opcode & 0b0000_0001) == 0b01;
     ...
     * imm from reg/mem            100000sw m101r disp     disp    data   data(if s:w=01)
     */
    public static class SbbRmImm extends Cpu.FixedClockOpcode {
        @Override
        public void executeClocked(Cpu cpu, int opcode) {
            boolean w = (opcode & 0b0000_0001) == 0b01;
            boolean imm16 = (opcode & 0b0000_0011) == 0b01;
     ...
     */
    public static class SbbAccImm extends Cpu.FixedClockOpcode {
        @Override
        public void executeClocked(Cpu cpu, int opcode) {
            boolean w = (opcode & 0b0000_0001) == 0b01;
     ...
     */
    public static class DecRm extends Cpu.FixedClockOpcode {
        @Override
        public void executeClocked(Cpu cpu, int opcode) {
            boolean w = (opcode & 0b0000_0001) == 0b01;
     ...
     */
    public static class DecReg extends Cpu.FixedClockOpcode {
        @Override
        public void executeClocked(Cpu cpu, int opcode) {
     ...
     *      set CF
     */
    public static class NegRm extends Cpu.FixedClockOpcode {
        @Override
        public void executeClocked(Cpu cpu, int opcode) {
            boolean w = (opcode & 0b0000_0001) == 0b01;
