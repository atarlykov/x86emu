 ...
 */
public class Logic implements Cpu.ClockedOpcodeConfiguration
{
    /*
     logical:
      of, cf  - cleared
    ...
    */
    ...
    public void getClockedConfiguration(Cpu.Opcode[] registry)
    {
        ...
        // SHL
        config(registry, "1101_001*", "**_100_***", C(20, 4, ShlSal.class,   "SHL", "[M],CL"));
        config(registry, "1101_001*", "11_100_***", C( 8, 4, ShlSal.class,   "SHL", "R,CL"), true);
        config(registry, "1101_000*", "**_100_***", S(15, 0, ShlSal.class,   "SHL", "[M],1"));
        config(registry, "1101_000*", "11_100_***", S( 2, 0, ShlSal.class,   "SHL", "R,1"), true);
        // SHR
        config(registry, "1101_001*", "**_101_***", C(20, 4, Shr.class,   "SHR", "[M],CL"));
        config(registry, "1101_001*", "11_101_***", C( 8, 4, Shr.class,   "SHR", "R,CL"), true);
        config(registry, "1101_000*", "**_101_***", S(15, 0, Shr.class,   "SHR", "[M],1"));
        config(registry, "1101_000*", "11_101_***", S( 2, 0, Shr.class,   "SHR", "R,1"), true);
        // SAR
        config(registry, "1101_001*", "**_111_***", C(20, 4, Sar.class,   "SAR", "[M],CL"));
        config(registry, "1101_001*", "11_111_***", C( 8, 4, Sar.class,   "SAR", "R,CL"), true);
        config(registry, "1101_000*", "**_111_***", S(15, 0, Sar.class,   "SAR", "[M],1"));
        config(registry, "1101_000*", "11_111_***", S( 2, 0, Sar.class,   "SAR", "R,1"), true);

        // ROL
        config(registry, "1101_001*", "**_000_***", C(20, 4, Rol.class,   "ROL", "[M],CL"));
        config(registry, "1101_001*", "11_000_***", C( 8, 4, Rol.class,   "ROL", "R,CL"), true);
        config(registry, "1101_000*", "**_000_***", S(15, 0, Rol.class,   "ROL", "[M],1"));
        config(registry, "1101_000*", "11_000_***", S( 2, 0, Rol.class,   "ROL", "R,1"), true);
        // ROR
        config(registry, "1101_001*", "**_001_***", C(20, 4, Ror.class,   "ROR", "[M],CL"));
        config(registry, "1101_001*", "11_001_***", C( 8, 4, Ror.class,   "ROR", "R,CL"), true);
        config(registry, "1101_000*", "**_001_***", S(15, 0, Ror.class,   "ROR", "[M],1"));
        config(registry, "1101_000*", "11_001_***", S( 2, 0, Ror.class,   "ROR", "R,1"), true);
        // RCL
        config(registry, "1101_001*", "**_010_***", C(20, 4, Rcl.class,   "RCL", "[M],CL"));
        config(registry, "1101_001*", "11_010_***", C( 8, 4, Rcl.class,   "RCL", "R,CL"), true);
        config(registry, "1101_000*", "**_010_***", S(15, 0, Rcl.class,   "RCL", "[M],1"));
        config(registry, "1101_000*", "11_010_***", S( 2, 0, Rcl.class,   "RCL", "R,1"), true);
        // RCR
        config(registry, "1101_001*", "**_011_***", C(20, 4, Rcr.class,   "RCR", "[M],CL"));
        config(registry, "1101_001*", "11_011_***", C( 8, 4, Rcr.class,   "RCR", "R,CL"), true);
        config(registry, "1101_000*", "**_011_***", S(15, 0, Rcr.class,   "RCR", "[M],1"));
        config(registry, "1101_000*", "11_011_***", S( 2, 0, Rcr.class,   "RCR", "R,1"), true);


        // AND
        config(registry, "0010_001*", "**_***_***", S( 9, AndRmR.class,   "AND", "R, M"));
        config(registry, "0010_001*", "11_***_***", S( 3, AndRmR.class,   "AND", "R, R"), true);
        config(registry, "0010_000*", "**_***_***", S(16, AndRmR.class,   "AND", "M, R"));
        config(registry, "0010_000*", "11_***_***", S( 3, AndRmR.class,   "AND", "R, R"), true);

        config(registry, "0010_010*",               S( 4, AndAccImm.class,         "AND", "A, I"));
        config(registry, "1000_000*", "**_100_***",  S(17, AndRmImm.class,         "AND", "M, I"));
        config(registry, "1000_000*", "11_100_***",  S( 4, AndRmImm.class,         "AND", "R, I"), true);
        config(registry, "1000_0011", "**_100_***",  S( 4, AndRmImmSignExt.class,  "AND", "A, Ix"));

        // TEST
        config(registry, "1000_010*", "**_***_***", S( 9, TestRmR.class,   "TEST", "R, M"));
        config(registry, "1000_010*", "11_***_***", S( 3, TestRmR.class,   "TEST", "R, R"), true);

        config(registry, "1010_100*",               S( 4, TestAccImm.class,         "TEST", "A, I"));
        config(registry, "1111_011*", "**_000_***",  S(11, TestRmImm.class,          "TEST", "M, I"));
        config(registry, "1111_011*", "11_000_***",  S( 5, TestRmImm.class,          "TEST", "R, I"), true);
        //config(c, "1000_0011", "**_000_***",  S( 4, TestRmImmSignExt.class,   "TEST", "A, I"));

        // XOR
        config(registry, "0011_001*", "**_***_***", S( 9, XorRmR.class,   "XOR", "R, M"));
        config(registry, "0011_001*", "11_***_***", S( 3, XorRmR.class,   "XOR", "R, R"), true);
        config(registry, "0011_000*", "**_***_***", S(16, XorRmR.class,   "XOR", "M, R"));
        config(registry, "0011_000*", "11_***_***", S( 3, XorRmR.class,   "XOR", "R, R"), true);

        config(registry, "0011_010*",                S( 4, XorAccImm.class,         "XOR", "A, I"));
        config(registry, "1000_000*", "**_110_***",  S(17, XorRmImm.class,          "XOR", "M, I"));
        config(registry, "1000_000*", "11_110_***",  S( 4, XorRmImm.class,          "XOR", "R, I"), true);
        config(registry, "1000_0011", "**_110_***",  S( 4, XorRmImmSignExt.class,   "XOR", "A, Ix"));

        // OR
        config(registry, "0000_101*", "**_***_***", S( 9, OrRmR.class,   "OR", "R, M"));
        config(registry, "0000_101*", "11_***_***", S( 3, OrRmR.class,   "OR", "R, R"), true);
        config(registry, "0000_100*", "**_***_***", S(16, OrRmR.class,   "OR", "M, R"));
        config(registry, "0000_100*", "11_***_***", S( 3, OrRmR.class,   "OR", "R, R"), true);

        config(registry, "0000_110*",                S( 4, OrAccImm.class,         "OR", "A, I"));
        config(registry, "1000_000*", "**_001_***",  S(17, OrRmImm.class,          "OR", "M, I"));
        config(registry, "1000_000*", "11_001_***",  S( 4, OrRmImm.class,          "OR", "R, I"), true);
        config(registry, "1000_0011", "**_001_***",  S( 4, OrRmImmSignExt.class,   "OR", "A, Ix"));

        // NOT
        config(registry, "1111_011*", "**_010_***",  S(16, Not.class,          "NOT", "[M]]"));
        config(registry, "1111_011*", "11_010_***",  S( 3, Not.class,          "NOT", "R"), true);
    }


    public static class Not extends Cpu.FixedClockOpcode {
        @Override
    ...
    public static class ShlSal extends Cpu.Opcode {
        @Override
        public void execute(Cpu cpu, int opcode) {
            ...
            if (v) {
                ...
                // CL based clocks
                cpu.clocks((short) (clocks + clocksAlt * count));
    ...
    public static class Shr extends Cpu.Opcode {
        @Override
        public void execute(Cpu cpu, int opcode) {
    ...
    public static class Sar extends Cpu.Opcode {
        @Override
        public void execute(Cpu cpu, int opcode) {
            boolean w = (opcode & 0b0000_0001) == 0b01;
            boolean v = (opcode & 0b0000_0010) == 0b10;
    ...
    public static class Rol extends Cpu.Opcode {
        @Override
        public void execute(Cpu cpu, int opcode) {
            boolean w = (opcode & 0b0000_0001) != 0b00;
            boolean v = (opcode & 0b0000_0010) != 0b00;
    ...
    public static class Ror extends Cpu.Opcode {
        @Override
        public void execute(Cpu cpu, int opcode) {
            boolean w = (opcode & 0b0000_0001) != 0b00;
            boolean v = (opcode & 0b0000_0010) != 0b00;
    ...
    public static class Rcl extends Cpu.Opcode {
        @Override
        public void execute(Cpu cpu, int opcode) {
            boolean w = (opcode & 0b0000_0001) != 0b00;
            boolean v = (opcode & 0b0000_0010) != 0b00;
    ...
    public static class Rcr extends Cpu.Opcode {
        @Override
        public void execute(Cpu cpu, int opcode) {
            boolean w = (opcode & 0b0000_0001) != 0b00;
            boolean v = (opcode & 0b0000_0010) != 0b00;
    ...
    public static class AndRmImm extends Cpu.Opcode {
        @Override
        public void execute(Cpu cpu, int opcode) {
    ...
    public static class AndRmImmSignExt extends Cpu.Opcode {
        @Override
        public void execute(Cpu cpu, int opcode) {
            final boolean w = (opcode & 0b0000_0001) == 0b01;
    ...
    public static class TestRmImm extends Cpu.Opcode {
        @Override
        public void execute(Cpu cpu, int opcode) {
            final boolean w = (opcode & 0b0000_0001) == 0b01;
    ...
    public static class TestRmImmSignExt extends Cpu.Opcode {
        @Override
        public void execute(Cpu cpu, int opcode) {
            final boolean w = (opcode & 0b0000_0001) == 0b01;
            final int imm = cpu.ipRead8WithSign();
    ...
    public static class XorRmImm extends Cpu.Opcode {
        @Override
        public void execute(Cpu cpu, int opcode) {
            final boolean w = (opcode & 0b0000_0001) == 0b01;
    ...
    public static class XorRmImmSignExt extends Cpu.Opcode {
        @Override
        public void execute(Cpu cpu, int opcode) {
            final boolean w = (opcode & 0b0000_0001) == 0b01;
    ...
    public static class OrRmImm extends Cpu.Opcode {
        @Override
        public void execute(Cpu cpu, int opcode) {
            final boolean w = (opcode & 0b0000_0001) == 0b01;
    ...
    public static class OrRmImmSignExt extends Cpu.Opcode {
        @Override
        public void execute(Cpu cpu, int opcode) {
            final boolean w = (opcode & 0b0000_0001) == 0b01;
