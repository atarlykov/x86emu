 ...
 */
public class Add implements Cpu.ClockedOpcodeConfiguration {
    ...
    {
        // ADD
        config(registry, "0000_000*", "**_***_***", S(16, AddRmR.class, "ADD", "[M] <-  R"));
        config(registry, "0000_001*", "**_***_***", S( 9, AddRmR.class, "ADD", " R  <- [M]"));
        config(registry, "0000_00**", "11_***_***", S( 3, AddRmR.class, "ADD", " R  <-  R"), true);

        config(registry, "0000_010*",               S( 4, AddAccImm.class, "ADD", " A   <- I"));
        config(registry, "1000_00**", "**_000_***", S(17, AddRmImm.class,  "ADD", "[M]  <- I"));
        config(registry, "1000_00**", "11_000_***", S( 4, AddRmImm.class,  "ADD", " Rm  <- I"), true);

        // ADC
        config(registry, "0001_000*", "**_***_***", S(16, AdcRmR.class, "ADC", "[M] <-  R"));
        config(registry, "0001_001*", "**_***_***", S( 9, AdcRmR.class, "ADC", " R  <- [M]"));
        config(registry, "0001_00**", "11_***_***", S( 3, AdcRmR.class, "ADC", " R  <-  R"), true);

        config(registry, "0001_010*",               S( 4, AdcAccImm.class, "ADC", " A   <- I"));
        config(registry, "1000_00**", "**_010_***", S(17, AdcRmImm.class,  "ADC", "[M]  <- I"));
        config(registry, "1000_00**", "11_010_***", S( 4, AdcRmImm.class,  "ADC", " Rm  <- I"), true);

        // INC
        config(registry, "0100_0***",               S( 2, IncReg.class, "INC", "R16"));
        config(registry, "1111_111*", "**_000_***", S(15, IncRm.class, "INC", "R"));
        config(registry, "1111_1110", "11_000_***", S( 3, IncRm.class, "INC", "R8"), true);
        config(registry, "1111_1111", "11_000_***", S( 2, IncRm.class, "INC", "R16"), true);

        // AAA & DAA
        config(registry, "0011_0111",               S( 4, Aaa.class, "AAA", ""));
        config(registry, "0010_0111",               S( 4, Daa.class, "DAA", ""));
    }
     ...
     */
    public static class AddRmR extends Cpu.FixedClockOpcode {
        @Override
     ...
     */
    public static class AddRmImm extends Cpu.FixedClockOpcode {
        @Override
        public void executeClocked(Cpu cpu, int opcode) {
            boolean w = (opcode & 0b0000_0001) == 0b01;
     ...
     */
    public static class AddAccImm extends Cpu.FixedClockOpcode {
        @Override
        public void executeClocked(Cpu cpu, int opcode) {
            boolean w = (opcode & 0b0000_0001) == 0b01;
     ...
     * Addition of reg/mem with reg
     */
    public static class AdcRmR extends Cpu.FixedClockOpcode {
        @Override
        public void executeClocked(Cpu cpu, int opcode)
        {
            boolean w = (opcode & 0b0000_0001) == 0b01;
     ...
     * Addition of reg/mem with immediate
     */
    public static class AdcRmImm extends Cpu.FixedClockOpcode {
        @Override
        public void executeClocked(Cpu cpu, int opcode) {
            boolean w = (opcode & 0b0000_0001) == 0b01;
            boolean imm16 = (opcode & 0b0000_0011) == 0b01;
     ...
     * Addition of accumulator with immediate
     */
    public static class AdcAccImm extends Cpu.FixedClockOpcode {
        @Override
        public void executeClocked(Cpu cpu, int opcode) {
            boolean w = (opcode & 0b0000_0001) == 0b01;
     ...
     */
    public static class IncRm extends Cpu.FixedClockOpcode {
        @Override
        public void executeClocked(Cpu cpu, int opcode) {
            boolean w = (opcode & 0b0000_0001) == 0b01;
     ...
     * flags updated (af,of,pf,sf,zf  not cf)
     */
    public static class IncReg extends Cpu.FixedClockOpcode {
        @Override
        public void executeClocked(Cpu cpu, int opcode) {
     ...
     */
    public static class Aaa extends Cpu.FixedClockOpcode {
        @Override
        public void executeClocked(Cpu cpu, int opcode)
        {
     ...
     */
    public static class Daa extends Cpu.FixedClockOpcode {
        @Override
        public void executeClocked(Cpu cpu, int opcode)
        {
